...
zip_file <- file.path("..", "Data", "RawData", "SolisenseCaloxy.zip")
...
SolFitsTrimOS <- SolFitsOS %>%
  ...
  mutate(Filename = str_remove(string = Filename, pattern = "/RawData/SolisenseCaloxy.zip/"),
...
saveRDS(SolFitsMeta, file.path(DataOut, paste(Project, "Imported_SolisenseLight_LRC_CaloxyAll.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
