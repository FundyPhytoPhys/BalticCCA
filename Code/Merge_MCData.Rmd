...
OD720_unnest <- LogFitsData %>%
  select(c(Filename, Tube, ExpDate, MC, PrimaryOperator, Run,  SampleID, Strain, ExpCul, ExpStartTime, Par_ue, Photoperiod, Temp_c, O2, WL, LightShape, Optode, OptodeCh, OptodeMeasure, ExpEndDate, ExpEndHour, PARPhotonDose_day, tubedata, minRollMeanOD720, maxRollMeanOD720, minRollMeandeltaOD, maxRollMeandeltaOD, OD720_logistic_tidied, OD720_logistic_predict, O2_Category)
         ) %>%
...
deltaOD_unnest <- LogFitsData %>%
   select(c(Filename,  Tube, ExpDate, MC, PrimaryOperator, Run,  SampleID, Strain, ExpCul, ExpStartTime, Par_ue, Photoperiod, Temp_c, O2, WL, LightShape,  Optode, OptodeCh, OptodeMeasure,  ExpEndDate, ExpEndHour, PARPhotonDose_day, tubedata, minRollMeanOD720, maxRollMeanOD720, minRollMeandeltaOD, maxRollMeandeltaOD, deltaOD_logistic_tidied, deltaOD_logistic_predict, O2_Category)
          ) %>%
...
OD720truncLog_unnest <- LogFitsData %>%
   select(c(Filename, Tube, ExpDate, MC, PrimaryOperator, Run,  SampleID, Strain, ExpCul, ExpStartTime, Par_ue, Photoperiod, Temp_c, O2, WL, LightShape,  Optode, OptodeCh, OptodeMeasure,  ExpEndDate, ExpEndHour, PARPhotonDose_day, tubedata, minRollMeanOD720, maxRollMeanOD720, minRollMeandeltaOD, maxRollMeandeltaOD, OD720trunc_logistic_tidied, OD720trunc_logistic_predict, O2_Category)
          ) %>%
...
deltaODtruncLog_unnest <- LogFitsData %>%
   select(c(Filename, Tube, ExpDate, MC, PrimaryOperator, Run,  SampleID, Strain, ExpCul, ExpStartTime, Par_ue, Photoperiod, Temp_c, O2, WL, LightShape,  Optode, OptodeCh, OptodeMeasure,  ExpEndDate, ExpEndHour, PARPhotonDose_day, tubedata, minRollMeanOD720, maxRollMeanOD720, minRollMeandeltaOD, maxRollMeandeltaOD, deltaODtrunc_logistic_tidied, deltaODtrunc_logistic_predict, O2_Category)
          ) %>%
