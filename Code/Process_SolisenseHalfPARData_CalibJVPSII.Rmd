...
```{r JVPSII calib}
# JVPSII_eLs_ModelTerms2 <- read_rds(file.path("..","Data", "CleanedData", "JVPSIIO2Calib", "JVPSII_eLs_ModelTerms.Rds"))
# 
# #smarter way to code this with 'which' in [] and map through Ex_WL
# SolFitsMeta <- left_join(SolFitsMeta, JVPSII_eLs_ModelTerms, by = join_by(Ex_WL)) |>
#   select(-c(Slope_P)) |>
...
# CHECK THIS SYLWIA!!! THERE COULD BE MISTAKE WITH EXPRESUPPLY!!!
