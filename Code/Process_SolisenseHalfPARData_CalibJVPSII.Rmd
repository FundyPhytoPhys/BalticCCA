...
SolFitsMetaFilter %>%
  ...
  #filter(Phase!= "St") %>% 
    #filter(Ex_WL!= 470 & Ex_WL != 505) %>% 
  ggplot() +
  geom_point(aes(x = E_days, y = Tau1QA, colour = as.factor(Phase)), size = 3, show.legend = T) +
  #geom_line(aes(x = E_days, y = TauAv, linetype = as.factor(Phase)), size = 0.3, show.legend = T) +
  #geom_vline(xintercept = 90, linetype = "dotted", size = 0.7) +
  scale_fill_identity() +
  ggh4x::facet_nested(cols = vars(Par_ue, WL), rows = vars(Strain, Ex_WL), labeller = label_parsed) +
  theme_bw() 
...
SolFitsMetaFilter %>%
  ...
  #filter(Phase!= "St") %>% 
    #filter(Ex_WL!= 470 & Ex_WL != 505) %>% 
  ggplot() +
  geom_point(aes(x = E_days, y = TauAv, colour = as.factor(Phase)), size = 3, show.legend = T) +
  #geom_line(aes(x = E_days, y = Alp1QA, linetype = as.factor(Phase)), size = 0.3, show.legend = T) +
  #geom_vline(xintercept = 90, linetype = "dotted", size = 0.7) +
  scale_fill_identity() +
  ggh4x::facet_nested(cols = vars(Par_ue, WL), rows = vars(Strain, Ex_WL), labeller = label_parsed) +
  theme_bw() 
...
SolFitsMetaFilter %>%
  ...
  filter(Ex_WL!= 470 & Ex_WL != 505) %>% 
  ggplot() +
  geom_point(aes(x = E_days, y = Alp2QA, colour = as.factor(Phase)), size = 3, show.legend = T) +
  #geom_line(aes(x = E_days, y = Alp2QA, linetype = as.factor(Phase)), size = 0.3, show.legend = T) +
  #geom_vline(xintercept = 90, linetype = "dotted", size = 0.7) +
  scale_fill_identity() +
  ggh4x::facet_nested(cols = vars(Par_ue, WL), rows = vars(Strain, Ex_WL), labeller = label_parsed) +
  theme_bw() 
...
```
```{r reate plot, fig.height = 10, fig.width = 6, warning = FALSE}
SolFitsMeta %>%
  mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
    filter(Phase!= "St") %>% 
  filter(Ex_WL!= 470 & Ex_WL != 505) %>% 
  ...
  #geom_vline(xintercept = 90, linetype = "dotted", size = 0.7) +
  scale_fill_identity() +
  ggh4x::facet_nested(cols = vars(Par_ue, WL), rows = vars(Strain, Ex_WL, Run), labeller = label_parsed) +
  theme_bw() 
```
...
SolFitsMetaLRC %>%
  ...
  filter(Phase != "St") %>% 
  ggplot() +
  geom_point(aes(x = ActPARCorr, y = Sig, colour = as.factor(Phase)), size = 2, show.legend = T) +
  scale_fill_identity() +
...
SolFitsMetaLRC %>%
  ...
  filter(Phase != "St") %>% 
  ggplot() +
  geom_point(aes(x = ActPARCorr, y = TauAv, colour = as.factor(Phase)), size = 2, show.legend = T) +
  scale_fill_identity() +
  ggh4x::facet_nested(cols = vars(WL, Par_ue), rows = vars(Strain, Ex_WL), labeller = label_parsed) +
  theme_bw()
...
SolFitsMetaLRC <- SolFitsMetaLRC %>%
  ...
  group_by(Strain, Run, Ex_WL, Par_ue, Photoperiod, WLNum, WL, O2, E_days, ObsDate, ActPARCorr, Phase) %>%
  
  summarize(SampleID, Ex_WL, FilenameSolisense, Run, Strain, ExpDate, Par_ue, Photoperiod, O2, WL, WLNum,  PARPhotonDose_day, ObsDate, ObsTime, ObsDateTime, Sig, Sig_nm2psii, ActPARCorr, ActPARCorr_photonsm2s, Sigdark_nm2psii, FoOxbo, qpOxbo, JVPSII_umol_eLs, E_days, TauAv, qpOxbo, ETRqpOxbo, Phase,
...
SolFitsMetaLRC <- SolFitsMetaLRC %>%
  ...
  summarize(SampleID, Ex_WL, FilenameSolisense, Run, Strain, ExpDate, Par_ue, Photoperiod, O2, WL, WLNum,  PARPhotonDose_day, ObsDate, ObsTime, ObsDateTime, Sig, Sig_nm2psii, meanSig_nm2psii, sdSig_nm2psii, meanSigdark_nm2psii, sdSigdark_nm2psii, ActPARCorr, ActPARCorr_photonsm2s, Sigdark_nm2psii, FoOxbo, qpOxbo, JVPSII_umol_eLs, E_days, TauAv, qpOxbo, meanTauAv, sdTauAv, meanqpOxbo, sdqpOxbo, meanJVPSII_umol_eLs, sdJVPSII_umol_eLs, ETRqpOxbo, meanETRqpOxbo, sdETRqpOxbo, Phase,
...
SolFitsMetaLRC %>%
  ...
  filter(Ex_WL == 445 | Ex_WL == 535 | Ex_WL == 590) %>%
  ggplot() +
  geom_point(aes(x = ActPARCorr, y = Sig_nm2psii, colour = as.factor(Phase)), size = 2, show.legend = T) +
