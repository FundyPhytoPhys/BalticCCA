...
drectgreen <- data.frame(Ex_WL = c("535", "535"), Strain = c("PC-rich", "PE-rich"), WL = c("530", "530"), Par_ue = c(60, 300),  x1=c(-Inf), x2=c(Inf), y1=c(-Inf), y2=c(Inf))

drectred <- data.frame(Ex_WL = c("590", "590"), Strain = c("PC-rich", "PE-rich"), WL = c("660", "660"), Par_ue = c(60, 300), x1=c(-Inf), x2=c(Inf), y1=c(-Inf), y2=c(Inf))
