...
Process_MCData.Rmd processes and combines all .Rds from Data/ImportedData/ImportedMCData folder and creates Rds.
...
```{r read ProcessFile}
ProcessFile <- "../Data/ImportedData/ImportedMCData/20220507_PICO_MCMIX004_RUN700_TargetDataMetaFilter.Rds"
