...
OLISSpectraMetaPUR_Resup2 %>%
  ...
  ggh4x::facet_nested(rows = vars(facetsStrain, Strain), cols = vars(WL, Par_ue),labeller = labeller(Ex_WL = label_value, WL = label_value)) +
...
OLISSpectraMetaPhasePlot %>%
  ...
  scale_fill_identity() +
  labs(y = "PUR and normalized LED emission spectra", x = "Growth waveband (nm)") +
