...
# Filter 8 spectra that do not match to growth curve - day 7 because Run 56 after day 7 also sowed change in pigments (CCA) without resupply! I will deal with it later.
...
# Create a better plot - only exp i ExpResup - spectra taken at E_day = 2
...
OLISSpectraMetaPhasePlot %>%
  ...
  geom_line(aes(x = WLNum, y = PUR, linetype = as.factor(Phase)), show.legend = T) +
  ...
  scale_fill_identity() +
  labs(y = "PUR and normalized emission spectra", x = "Growth waveband (nm)") +
