...
```{r}
# OLISSpectraMetaPUR_Resup<-OLISSpectraMetaPUR %>%
#   filter(WL!= "WW") %>% 
#   filter(Run == 70 | Run == 68 | Run == 59) %>% 
#  filter(E_days == 7 | E_days == 16)
# 
# 
# OLISSpectraMetaPUR_Resup<-OLISSpectraMetaPUR_Resup %>% 
...
# Filter 8 spectra that do not match to growth curve - day 7 because Run 56 after day 7 also sowed change in pigments without resupply! I will deal with it later.
...
# Create a better plot - exp i ExpResup - spectra taken at E_day = 2
