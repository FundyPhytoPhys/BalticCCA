...
zip_file <- file.path("..", "Data", "RawData", "SolisenseSySlCCACaloxy.zip")
...
SolFitsTrimOS <- SolFitsOS %>%
  ...
  mutate(Filename = str_remove(string = Filename, pattern = "/RawData/SolisenseSySlCCACaloxy.zip/"),
...
saveRDS(SolFitsMeta, file.path(DataOut, paste(Project, "Imported_SolisenseLight_LRC_Caloxy.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
