...
#### Problem to fix - growth rate - Exp and ExpResupply - Run 70 and Run 0
PUR - Exp and ExpResupply - Run 70 


#### Problem with Phase!!!!!! Growth rate - only Exp and ExpResupply!!! Change the name of columns so they do not match?


- co zrobic: wywalic run 0, zmienic na 70. Wyrzucic lub zmienic SampleID. Zrobic filtr i wyrzucuc na razie reszte run.
...
#ExpDate
  # select(c(Tube, ExpDate, MC, Strain, Par_ue, Photoperiod, WL, O2, LightShape, PARPhotonDose_day, OD720_Lmu_se, OD720_Lmu_corr, deltaOD_Lmu_se, deltaOD_Lmu_corr, Phase))
