...
MultiCultiGrowth %>%
  #filter(WL != "WW") %>% 
  ggplot() +
  geom_point(aes(x = OD720_Lmu_corr, y = deltaOD_Lmu_corr,colour=as.factor(Strain)), size = 3.5, alpha = 0.9, show.legend = T) +
  geom_smooth(aes(x = OD720_Lmu_corr, y = deltaOD_Lmu_corr, linetype=as.factor(Strain)), size = 1, alpha = 0.2, show.legend = T, method = "lm") +
