...
MCGrowthRateSelect <- OlisSelect %>% 
  left_join(., MultiCultiGrowthSelect, by = c("Run" = "Run", "SampleID" = "SampleID","Strain" = "Strain", "Par_ue" = "Par_ue", "Photoperiod" = "Photoperiod",  "O2" = "O2", "WL" = "WL", "ExpDate" = "ExpDate", "PARPhotonDose_day" = "PARPhotonDose_day", "Phase" = "Phase")) 
