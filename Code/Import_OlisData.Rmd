...
# zip_file <- file.path("..", "Data", "RawData", "OlisDataChoosen.zip")
...
# saveRDS(OLISSpectraMeta440, file.path(DataOut, paste(Project, "Imported_OlisDataChoosen.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
