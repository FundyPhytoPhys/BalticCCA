...
data_textExp <- data.frame(facetsPar_ue = c("PAR~(µmol~photons~m^{-2}~s^{-1})", "PAR~(µmol~photons~m^{-2}~s^{-1})"), facetsStrain = c("Strain", "Strain"), Strain  = c("PC-rich", "PE-rich", "PC-rich", "PE-rich"), Par_ue  = c(60, 60, 60, 60, 300, 300, 300, 300), label = c('Initial growth curve', 'Initial growth curve', 'Initial growth curve', 'Initial growth curve'))

data_textResup <- data.frame(facetsPar_ue = c("PAR~(µmol~photons~m^{-2}~s^{-1})", "PAR~(µmol~photons~m^{-2}~s^{-1})"), facetsStrain = c("Strain", "Strain"), Strain  = c("PC-rich", "PE-rich", "PC-rich", "PE-rich"), Par_ue  = c(60, 60, 60, 60, 300, 300, 300, 300), label = c('Resupply', 'Resupply', 'Resupply', 'Resupply'))
